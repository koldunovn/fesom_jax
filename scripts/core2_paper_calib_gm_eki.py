...
Usage (GPU):  python scripts/core2_paper_calib_gm_eki.py --mode twin --n 240 --members 16
              python scripts/core2_paper_calib_gm_eki.py --mode budget --n 240
              python scripts/core2_paper_calib_gm_eki.py --mode obs  --n 480 --n-spin 480
"""
