...
fresh allocator pool (the D2a split). Usage:
  python scripts/core2_paper_nn_obs.py --mode train    --n 10 --windows 8 --holdout random --fold 0
  python scripts/core2_paper_nn_obs.py --mode validate --long-steps 4320 --long-seg 240
"""
