...
Usage (CPU):
  JAX_PLATFORMS=cpu python scripts/core2_lw_ref_check.py                    # full
  JAX_PLATFORMS=cpu python scripts/core2_lw_ref_check.py --snap-stride 146  # ~5 snapshots (smoke)
"""
...
RESULTS = Path(__file__).resolve().parents[0] / "lw_ref_check.jsonl"
