...
# Usage:  sbatch scripts/core2_kpp_stability_gpu.sh             # both, ~10 days
#         sbatch scripts/core2_kpp_stability_gpu.sh 5184 kpp    # KPP only, ~30 days
...
"$PY" scripts/core2_kpp_stability_run.py --steps "$STEPS" --every 50 --mixing "$MIX"
echo "exit: $?"
