...
Usage
-----
    python scripts/core2_stability_run.py --steps 172            # 1 day, dt=500
    python scripts/core2_stability_run.py --steps 1728 --every 50  # ~10 days
...
def build(year: int, steps: int):
    ...
    cf = core2_forcing.build_core_forcing(
