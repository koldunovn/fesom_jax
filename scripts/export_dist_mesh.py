...
Usage:
    python scripts/export_dist_mesh.py <npes> [out_dir]
    python scripts/export_dist_mesh.py 4
    python scripts/export_dist_mesh.py 2 /work/ab0995/a270088/mesh_core2_dist2
"""
