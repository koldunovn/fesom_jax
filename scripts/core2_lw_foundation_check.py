...
Usage:
  JAX_PLATFORMS=cpu python scripts/core2_lw_foundation_check.py            # full (all snapshots)
  JAX_PLATFORMS=cpu python scripts/core2_lw_foundation_check.py --snap-stride 0   # final pkl only (smoke)
"""
