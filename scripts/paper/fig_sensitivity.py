...
Usage:  python scripts/paper/fig_sensitivity.py --results <file.jsonl> --out scripts/fig_sensitivity.png
"""
...
def main():
    ...
    if not args.results.exists():
        print(f"no results file {args.results}; run scripts/paper/core2_paper_sensitivity.py first")
        return 1
