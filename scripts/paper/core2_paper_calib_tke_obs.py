...
(``scripts/tools/make_woa_targets.py`` → ``woa_targets.npz``) — the per-month-then-average that avoids the
...
Single-GPU only. Usage:  python scripts/paper/core2_paper_calib_tke_obs.py --n-spin 480 --n 12
"""
