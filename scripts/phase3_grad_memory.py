...
Usage (one fresh process per mode so peak-memory stats are clean):
    python scripts/phase3_grad_memory.py --n 200 --checkpoint
    python scripts/phase3_grad_memory.py --n 200 --no-checkpoint
Submit on a GPU node via scripts/phase3_grad_memory.sbatch.
"""
