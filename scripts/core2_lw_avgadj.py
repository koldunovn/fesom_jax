...
Usage (GPU):
  python scripts/core2_lw_avgadj.py --mode adjoint --target mld_ck   --snap-dir $WORK/longwindow/ref10_snaps --K 200
  python scripts/core2_lw_avgadj.py --mode tlm     --target mld_ck   --snap-dir $WORK/longwindow/ref10_snaps --K 200
  python scripts/core2_lw_avgadj.py --mode adjoint --target t100_kgm --snap-dir $WORK/longwindow/ref10_snaps --K 200
"""
