...
# Usage:  sbatch scripts/archive/core2_gm_stability_gpu.sh             # GM ON, ~10 days
#         sbatch scripts/archive/core2_gm_stability_gpu.sh 1728 off    # ice-only baseline
...
"$PY" scripts/archive/core2_gm_stability_run.py --steps "$STEPS" --every 50 --gm "$GM"
echo "exit: $?"
