...
Usage:  python scripts/archive/core2_kpp_stability_run.py --steps 1728 --every 50          # both
        python scripts/archive/core2_kpp_stability_run.py --steps 1728 --mixing kpp
"""
