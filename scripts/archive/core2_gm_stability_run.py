...
Usage:  python scripts/archive/core2_gm_stability_run.py --steps 1728 --every 50          # GM ON
        python scripts/archive/core2_gm_stability_run.py --steps 1728 --every 50 --gm off  # baseline
"""
